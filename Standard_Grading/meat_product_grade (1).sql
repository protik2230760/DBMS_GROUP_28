...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2025 at 09:07 AM
...
--
ALTER TABLE `meat_product_grade`
  ADD CONSTRAINT `meat_product_grade_ibfk_1` FOREIGN KEY (`Product_Type_ID`) REFERENCES `meat_product_type` (`Product_Type_ID`) ON DELETE CASCADE;

--
-- Constraints for table `meat_product_type`
--
ALTER TABLE `meat_product_type`
  ADD CONSTRAINT `meat_product_type_ibfk_1` FOREIGN KEY (`Cattle_ID`) REFERENCES `cattle` (`Cattle_ID`) ON DELETE CASCADE;
